...
class Applications_hosts extends Newrelic{
    ...
    public function getList($apikey, $id){
        $this->url = 'https://api.newrelic.com/v2/applications/'.$id.'/hosts';
        $accounts = array();
    ...
    public function getShow($apikey, $id, $host_id){
        $this->url = 'https://api.newrelic.com/v2/applications/'.$id.'/hosts/'.$host_id;
